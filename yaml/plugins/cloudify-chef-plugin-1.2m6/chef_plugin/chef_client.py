...
#        return cc['node_name_prefix'] + node_id + cc['node_name_suffix']
        return cc['node_name_prefix'] + node_id + str(random.randint(1, 500000)) + cc['node_name_suffix']
...
class ChefClientManager(ChefManager):
    ...
    def install_files(self):
        ...
        node_name = node_name + str(random.randint(1, 500000))
        ctx.logger.info("xxxXXXxxx node_name is {0}\n".format(node_name))
